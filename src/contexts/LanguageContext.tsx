...
export const LanguageProvider: React.FC<LanguageProviderProps> = ({ children }) => {
    ...
    const translations = {
        ...
        'dogs.lucas.description': { en: 'Loves food except tomatoes, if you want company while you\'re eating Lucas is your guy', ru: 'Любит еду, кроме помидоров, если вы хотите компанию во время еды, Лукас - ваш парень' },
        'dogs.bobby.description': { en: 'If you\'re looking for a dance partner full of energy, Bobby is your guy', ru: 'Если вы ищете танцевального партнера, полного энергии, Бобби - ваш парень' },
        'dogs.charlie.description': { en: 'Charlie is the cool kid, quiet and easy company for you', ru: 'Чарли - крутой парень, тихий и легкая компания для вас' },
        'dogs.alex.description': { en: 'Alex has the most innocent gaze and will make you forget your troubles', ru: 'У Алекса самый невинный взгляд, который заставит вас забыть о ваших проблемах' },
        'dogs.rex.description': { en: 'Rex loves sleeping on the couch, make sure he is allowed', ru: 'Рекс любит спать на диване, убедитесь, что ему это разрешено' },
