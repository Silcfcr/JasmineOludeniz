...
export const LanguageProvider: React.FC<LanguageProviderProps> = ({ children }) => {
    ...
    const translations = {
        ...
        'clients.review1': { en: 'Amazing place with great food and friendly staff!', ru: 'Потрясающее место с отличной едой и дружелюбным персоналом!' },
        'clients.review1.author': { en: 'Sarah M.', ru: 'Сара М.' },
        'clients.review1.location': { en: 'London, UK', ru: 'Лондон, Великобритания' },
        'clients.review2': { en: 'Perfect family accommodation with beautiful pool area.', ru: 'Идеальное семейное размещение с красивой зоной бассейна.' },
